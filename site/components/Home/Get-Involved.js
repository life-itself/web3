        ...
        <div className="mt-12 sm:mt-16 lg:mt-0">
          <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
            <img
              ...
              src="https://res.cloudinary.com/ds7qslkd0/image/upload/v1646745020/Web3/undraw_development_re_g5hq_dyesjo.svg"
              alt="Get Involved"
            />
          </div>
        </div>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
          <div className="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
            <img
              ...
              src="https://res.cloudinary.com/ds7qslkd0/image/upload/v1649244821/Web3/undraw_posts_re_ormv_bxhknn.svg"
              alt="Our Forum"
            />
          </div>
        </div>
