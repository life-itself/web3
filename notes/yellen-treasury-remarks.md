...
Digitization and straight through processing have led to financial innovation in the past
...
*Yellen presents the theoretical proposition of blockchain technology*
...
The administration regards crypto assets as non-currencies because of their inherent volatility and transaction costs being too prohibitive to allow commerce.
...
The Biden administration has a vested interest and a clear mandate to developing a framework that protects the public.
...
The federal framework needs to address specific claims and risks associated with this technology.
...
Lip service to the truism that financial innovation is sometimes good.
...
Some people suggest that [central bank digital currencies](../concepts/cbdc.md) are a better solution to the Federal Reserver's technical infrastructure.
...
The administration is looking into this and researching it, but it is unclear at this time what benefit a CBDC would bring.
...
Stablecoins are currently very risky and unregulated.
...
Runs on stablecoins have occurred in the past.
...
Stablecoins *need* to be regulated as bank-like entities.
...
Possibly [blockchain tech](../claims/is-blockchain-tech.md) could increase transparency in markets. But it currently is unclear how. These technologies could also create [systemic risk](../concepts/systemic-risk.md) if left unchecked.
...
We don't know what to do yet. But it should be guided by some basic ideas.
...
The underlying technology (be it blockchain or not) does not matter so much as *what* people are doing. And if what they are doing comes attached to consumer risk. (i.e. creating a lending platform on a blockchain does not alter the fact that people are issuing loans which is a regulated activity)
...
Crypto needs to be brought within the normal KYC/AML framework that almost every other financial service provider that interacts with US person's needs to comply with.
...
The nature of money may change over time but needs to be guided by an overarching theory and philosophy which serves the nation's interests.
...
Private money is a *really* bad idea.
...
Our current fiat monetary system works very well.
...
CBDCs are an interesting idea. We're looking into it. But there are a lot of open questions.
...
The fiat system post [Bretton Woods](../concepts/bretton-woods.md) has worked very well and the United States has no interest in so-called [sound money](../concepts/sound-money.md) systems.
...
We'll study CBDCs some more. But it remains unclear what to do at this point in time.
